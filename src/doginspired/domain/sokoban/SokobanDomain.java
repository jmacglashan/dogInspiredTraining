...
/**
 * This class is here for legacy reasons. Do not use it. Instead, use {@link doginspired.domain.sokoban2.Sokoban2Domain}.
 */
public class SokobanDomain implements DomainGenerator, StateParser {
	...
	public static void main(String args[]){
		...
		//read trajectory from file
			...
			System.out.println("Functionality no longer supported.");
			System.exit(0);
		}
